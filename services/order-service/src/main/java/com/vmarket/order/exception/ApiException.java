 ...
 *
 * <p>Cùng hình dạng với {@code com.vmarket.auth.exception.ApiException} và
 * {@code com.vmarket.user.exception.ApiException} để mã lỗi và body lỗi của toàn
 * hệ thống nhất quán.
 */
@Getter
public class ApiException extends RuntimeException {
	...
	/** Service phụ thuộc chưa kết nối được — request chắc chắn chưa chạy, thử lại được. */

...
/**
 * Nguồn cấu hình CORS cho order-service khi bị gọi trực tiếp (cổng 8086) lúc debug.
 * Luồng chính đi qua API Gateway — gateway mới là nơi chịu trách nhiệm CORS.
 *
 * <p>Phải là bean {@link CorsConfigurationSource} (giống auth/user-service) chứ không
 ...
 * {@code app.cors.allowed-origins}, nên preflight {@code OPTIONS /api/orders}

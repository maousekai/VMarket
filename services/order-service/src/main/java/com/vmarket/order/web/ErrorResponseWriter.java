 ...
 * nên {@code GlobalExceptionHandler} không với tới được. Gom vào đây để
 * {@code SecurityConfig} không phải tự dựng một body lỗi riêng khiến frontend phải
 * viết thêm nhánh xử lý.
 */

 ...
 *
 * <p>Giữ nguyên hình dạng với auth/user/cart-service để frontend chỉ cần một hàm
...
public record ErrorResponse(Error error) {
	...
	public record FieldError(
			@Schema(example = "addressId") String field,
			@Schema(example = "Địa chỉ giao hàng không được để trống") String message) {
	}

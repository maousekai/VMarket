...
/**
 * Cấu hình JWT của shop-service — chỉ có {@code secret} để <b>verify</b>.
 *
 ...
 * (đối xứng), nên mọi bên verify phải cùng một chuỗi bí mật. Cùng khuôn với
 * {@code com.vmarket.user.config.UserJwtProperties}.
 *
...
public class ShopJwtProperties {
	 ...
	 * được {@code @NotBlank} nhưng {@code Keys.hmacShaKeyFor} sẽ ném
	 * {@code WeakKeyException} — chặn ngay lúc bind cấu hình thì rõ nguyên nhân hơn.
	 */
	@NotBlank
